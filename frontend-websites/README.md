...
Confira diversos tamplates e projetos de sites para você treinar suas habilidades como desenvolvedor. Os projetos resumem os principais aspectos, desde sua estrutura e layout até o design e as tecnologias utilizadas.
...
```bash
git clone https://github.com/be-frontend/frontend-websites.git
```
